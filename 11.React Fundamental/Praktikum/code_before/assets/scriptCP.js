// Pengambilan Elemen
const inputName = document.querySelector(".prodName input");
const choiceCategory = document.querySelector(".prodCategory select");
...
const inputPrice = document.querySelector(".prodPrice input");
...
function tampilAlert() {
    ...
    // Loop melalui data formulir dan tambahkan sel ke dalam baris
    for (const key in formData) {
        const cell = newRow.insertCell();
        cell.innerHTML = formData[key];
    }

    // Kosongkan kolom-kolom formulir setelah pengiriman
    inputName.value = "";
