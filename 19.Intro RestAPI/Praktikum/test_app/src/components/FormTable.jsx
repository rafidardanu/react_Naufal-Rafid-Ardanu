...
const validateWeb = async () => {
    ...
    const newData = {
        ...
        try {
            ...
            const response = await axios.post('https://651b9f60194f77f2a5ae9f3f.mockapi.io/product', newData);
        ...
        <tbody>
            ...
            <tr key={index}>
                ...
                <td>
                    ...
                    <button className='btn btn-success' onClick={() => handleDetailClick(product.id)}>Detail</button>
                </td>
            </tr>
        ))}
        </tbody>
