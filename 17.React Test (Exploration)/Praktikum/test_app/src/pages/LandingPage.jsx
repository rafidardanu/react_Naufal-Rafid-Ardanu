...
<>
    <nav className="fixed-top navbar navbar-expand-lg navbar-dark">
        ...
        <a className="navbar-brand nav-judul" href="#">
            <img src="./profile/logo.png" alt="logo" className="navbar-logo" />
            eduTech
        </a>
        <button
    ...
    <main>
        ...
        <div className="container">
            ...
            <div className="col-12 col-md-6">
                ...
                <p>
                With eduTech, you can become a professional front-end developer.
                By taking free classes, you can hone your skills as a world-class
                programmer and compete with big companies like Amazon.
                </p>
                <Link to="/CProduct">
            ...
            <div className="col-12 col-md-6">
                <img
                src="http://digitalcrew360.com/wp-content/uploads/2021/05/web-development-india.png"
                className="img-fluid"
                alt=""
                />
            </div>
        ...
        <div className="container">
            ...
            <h6 className="">Our Creative Portfolio</h6>
            <h2 className="fw-bold fs-2">Discover Our Innovative Projects.</h2>
            </div>
            <div className="row mt-4 gap-2 gap-md-0">
            <div className="col-lg-4 col-sm-12 col-md-6">
                <div className="border-2 border">
                <img className="img-fluid" src="./profile/1.png" alt="" />
                <div className="px-4 pt-4 pb-2 our-project">
                    <h1 className="fw-bold">Artificial Intelligence</h1>
                    <p className="mt-2">
                    This AI project aims to introduce artificial intelligence (AI)
                    technology to society. We present AI information in an
                    easy-to-understand way, helping people learn about AI and its
            ...
            <div className="col-lg-4 col-sm-12 col-md-6">
                <div className="border-2 border">
                <img className="img-fluid" src="./profile/2.png" alt="" />
                <div className="px-4 pt-4 pb-2 our-project">
                    <h1 className="fw-bold">Business Project</h1>
                    <p className="mt-2">
                    business project aims to revolutionize the way companies
                    operate. We provide innovative solutions to streamline
                    processes, enhance efficiency, and boost profitability. With
            ...
            <div className="col-lg-4 col-sm-12 col-md-6">
                <div className="border-2 border">
                <img className="img-fluid" src="./profile/3.png" alt="" />
                <div className="px-4 pt-4 pb-2 our-project">
                    <h1 className="fw-bold">Information &amp; Media Literacy</h1>
                    <p className="mt-2">
                    Information &amp; Media Literacy is a crucial skill in the
                    digital age. It encompasses the ability to critically evaluate
                    and navigate the vast amount of information and media
                    available today.
                    </p>
                </div>
                </div>
            ...
            <div className="col-lg-4 col-sm-12 col-md-6">
                <div className="border-2 border">
                <img className="img-fluid" src="./profile/4.png" alt="" />
                <div className="px-4 pt-4 pb-2 our-project">
                    <h1 className="fw-bold">Coding School</h1>
                    <p className="mt-2">
                    Coding School for Kids is an exciting learning platform
                    designed to introduce children to the world of coding and
                    programming. Through engaging and interactive classes, kids
                    can develop essential coding.
                    </p>
                </div>
                </div>
            </div>
        ...
        <div className="container">
            ...
            <div className="main-title col-sm-12 col-md-6 col-lg-4">
                ...
                inquiry or find the department gmail youd like to contact below.
                </p>
            </div>
        ...
        <div className="container">
            ...
            <div className="footer1 col-sm-12 col-md-6 col-lg-5">
                ...
                <img width={40} height={40} src="./profile/logo.png" alt="logo" />
                <h1 className="fw-bold">eduTech</h1>
                </div>
                <p className="mt-3">
            ...
            <div className="footer3 col-sm-12 col-md-3 col-lg-4 pt-2">
                <h3 className="fw-bold">Find Us on Social Media</h3>
