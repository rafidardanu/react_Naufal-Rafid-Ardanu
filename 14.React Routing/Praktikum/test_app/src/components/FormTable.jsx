        ...
        <tbody>
            ...
            <tr key={index}>
                ...
                <td>
                    ...
                    <button className='btn btn-danger ms-2' onClick={() => confirmDeleteList(index)}>Delete</button>
                    <button className='btn btn-success ms-2' onClick={() => handleEditClick(product.number)}>Detail</button>
                </td>
            </tr>
        ))}
        </tbody>
